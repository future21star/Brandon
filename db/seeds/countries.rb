...
SeedableCountry.create(
    [{
          ...
          {:name => "Central African", :alpha2 => "CF", :alpha3 => "CAF"},
          ...
          {:name => "Republic of the Congo", :alpha2 => "CG", :alpha3 => "COG"},
          {:name => "The Democratic Republic Of The Congo", :alpha2 => "CD", :alpha3 => "COD"},
          ...
          {:name => "Occupied Palestinian Territory", :alpha2 => "PS", :alpha3 => "PSE"},
          ...
          {:name => "Islamic Republic of Iran", :alpha2 => "IR", :alpha3 => "IRN"},
          ...
          {:name => "Democratic People's Republic of Korea", :alpha2 => "KP", :alpha3 => "PRK"},
          {:name => "Republic of Korea", :alpha2 => "KR", :alpha3 => "KOR"},
          ...
          {:name => "Libyan Arab Jamahiriya", :alpha2 => "LY", :alpha3 => "LBY"},
          ...
          {:name => "Republic of Moldova", :alpha2 => "MD", :alpha3 => "MDA"},
          ...
          {:name => "Federated States of Micronesia", :alpha2 => "FM", :alpha3 => "FSM"},
          ...
          {:name => "The Former Yugoslav Republic of Macedonia", :alpha2 => "MK", :alpha3 => "MKD"},
          {:name => "Egypt", :alpha2 => "EG", :alpha3 => "EGY"},
          {:name => "United Kingdom", :alpha2 => "GB", :alpha3 => "GBR"},
          {:name => "Isle of Man", :alpha2 => "IM", :alpha3 => "IMN"},
          {:name => "United Republic Of Tanzania", :alpha2 => "TZ", :alpha3 => "TZA"},
          {:name => "United States", :alpha2 => "US", :alpha3 => "USA"},
          {:name => "U.S. Virgin Islands", :alpha2 => "VI", :alpha3 => "VIR"},
